...
tools: ["OpenGL"]
links:
  github: "https://github.com/pranavsrathod/roller-coaster-splines"
seo:
  image:
...
<MediaEmbed src="/CS420/rollerCoaster.mp4" type="video" title="Roller coaster spline simulation demo" />
