...
tools: ["C++"]
links:
  github: "https://github.com/pranavsrathod/MotionCaptureInterpolation"
seo:
  image:
...
<MediaEmbed src="https://www.youtube.com/embed/qGeqzX3NPvI?si=zRkqSS1tIEWmvS6j" title="Motion capture interpolation comparison" />
...
- **Graph #1:** Linear Euler vs. Bezier Euler for the lfemur X-axis (frames 600–800, N=20)
  ...
  ![Linear Euler vs. Bezier Euler for the lfemur X-axis](/CS520/2/graph1.png)

- **Graph #2:** SLERP Quaternion vs. Bezier SLERP Quaternion for the lfemur X-axis (frames 600–800, N=20)

  ![SLERP Quaternion vs. Bezier SLERP Quaternion for the lfemur X-axis](/CS520/2/graph2.png)

- **Graph #3:** Linear Euler vs. SLERP Quaternion for root rotation around the Z-axis (frames 200–500, N=20)

  ![Linear Euler vs. SLERP Quaternion for root rotation around the Z-axis](/CS520/2/graph3.png)

- **Graph #4:** Bezier Euler vs. Bezier SLERP Quaternion for root rotation around the Z-axis (frames 200–500, N=20)

  ![Bezier Euler vs. Bezier SLERP Quaternion for root rotation around the Z-axis](/CS520/2/graph4.png)
